...
class Player {
    ...
    rollAttributes() {
        //console.log('Rolling dice...') - prints string (boring)
        for (const key in this.attributes) {
            let results = diceRoller(4, 6);
            results.sort(function(a,b){return a - b}); //sort and compare numbers
    ...
    printPlayer() {
        ...
        console.log(`NAME: ${this.name}`); //backticks allow for inline variables and expressions
        for (const [key, value] of Object.entries(this.attributes)) {
...
function sumArrayElements(array) {
    ...
    //return sum;
    //I wanna see the comparison so i'm commenting instead of deleting :)
